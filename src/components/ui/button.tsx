...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    (
        ...
        // ⚠️ When using `asChild`, Radix Slot must have exactly ONE child.
        // We also don't pass `disabled`/loader/icons here – the child element controls itself.
        if (asChild) {
            return (
        ...
        // Normal button: safe to use loader + icons
        return (
            <button
                className={classes}
                ref={ref}
