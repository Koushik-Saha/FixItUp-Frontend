    ...
    try {
        ...
        const [
            ...
            supabase
                ...
                .lte('total_stock', supabase.rpc('low_stock_threshold'))
                .limit(10),
        ])
        ...
        const revenue = {
            total: paidOrders.reduce((sum, o) => sum + Number(o.total_amount), 0),
            orders: paidOrders.length,
            average: paidOrders.length > 0
                ? paidOrders.reduce((sum, o) => sum + Number(o.total_amount), 0) / paidOrders.length
                : 0,
        }
        ...
        const wholesale = wholesaleResult.data || []
